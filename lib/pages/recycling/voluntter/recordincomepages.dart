...
class recordincomepages extends StatefulWidget {
  const recordincomepages({super.key});

  @override
  State<recordincomepages> createState() => _CreateAccountState();
}

class _CreateAccountState extends State<recordincomepages> {
  // ตัวแปร
  ...
  String selectedIncome = 'รายได้ (บาท)'; // ตั้งค่าค่าที่เลือกในรายการเริ่มต้น
                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Image.asset(
                                  'assets/re1.png', // แทนที่ assets/icon.png ด้วยพาธของไอคอนที่คุณต้องการ
                                  width: 60,
                                  height: 60,
                                ),
                              ],
