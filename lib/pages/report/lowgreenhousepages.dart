...
class lowgreenhousepages extends StatefulWidget {
  const lowgreenhousepages({super.key});

  @override
  State<lowgreenhousepages> createState() => _CreateAccountState();
}

class _CreateAccountState extends State<lowgreenhousepages> {
  // ตัวแปร
